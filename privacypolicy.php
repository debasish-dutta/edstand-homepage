...
<section>
  <div class="container" style="margin-bottom:70px;">
        ...
        <p>This Privacy Policy governs the manner in which edStand collects, uses, maintains and discloses information collected from users (each, a "User") of the http://edstand.com website ("Site").</p>
        <h3>What personal information do we collect from the people that visit our blog, website or app?</h3>
        <p >When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, phone number, work setails or other details to help you with your experience.</p>
        ...
        <p>edStand may collect and use Users personal information for the following purposes:</p>
        <ul>
          <li>
        ...
        <p>edStand has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site, revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
        ...
        <p>This document was last updated on January 31, 2018</p>
  </div>
</section>
<?php
