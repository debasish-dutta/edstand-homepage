...
$tchsub = mysqli_real_escape_string($link, $_POST['tsub']);
$tchfield = mysqli_real_escape_string($link, $_POST['expertise']);
$advMath = mysqli_real_escape_string($link, $_POST['advMath']);
$tchtsub = $tchsub."-".$advMath;
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="class" id="cls" value="3">
        <label class="form-check-label" for="cls3">3</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="class" id="cls" value="4">
        <label class="form-check-label" for="cls4">4</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="class" id="cls" value="5">
        <label class="form-check-label" for="cls5">5</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="class" id="cls" value="6">
        <label class="form-check-label" for="cls6">6</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="class" id="cls" value="7">
        <label class="form-check-label" for="cls7">7</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="class" id="cls" value="8">
        <label class="form-check-label" for="cls8">8</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="class" id="cls" value="9">
